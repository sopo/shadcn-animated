  ...
  return (
    <div className="py-18 px-4">
      <Accordion
        ...
        className="w-65 max-w-lg md:w-lg rounded-2xl bg-white p-4 h-auto"
      >
        <AccordionItem value="shipping" className={``}>
          <AccordionTrigger
            className={`hover:no-underline text-lg font-medium **:data-[slot=accordion-trigger-icon]:size-5`}
          >
